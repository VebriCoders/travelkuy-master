        ...
        <?php foreach ($viewTour->result() as $data) { ?>
            <div class="section-header">
                <div class="section-header-button">
                    <a href="<?php echo base_url('tour') ?>" class="btn btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="Kembali Ke List Tour & Travel"><i class="fas fa-angle-double-left"></i></a>
                </div>
                &nbsp
                <h1>Gallery Tour & Travel (<?php echo $data->nama_tour_travel ?>)</h1>
                <div class="section-header-button">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Gallery Tour & Travel</div>
                </div>
            </div>
        <?php } ?>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    <article class="article">
                        <div class="article-header">
                            <div class="article-image" data-background="<?php echo base_url('assets/') ?>upload/foto_tour/gallery/<?php echo $data->photo ?>">
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <?php foreach ($viewTour->result() as $data_nm) { ?>
                        <h5 class="modal-title">Hapus Data Gallery Tour & Travel (<?php echo $data_nm->nama_tour_travel ?>)</h5>
                    <?php } ?>
                ...
                <?php foreach ($viewTour->result() as $data_slug) { ?>
                    <?php $slug_data = $data_slug->slug_url ?>
                <?php } ?>

                <div class="modal-footer bg-whitesmoke br">
                    <a class="btn btn-danger" href="<?php echo base_url('tour/hapus_gallery/' . $slug_data . '/' . $data->id) ?>">Hapus</a>
...
<!-- Modal Tambah Data -->
<?php foreach ($viewTour->result() as $data) { ?>
    <?php echo form_open_multipart('tour/add_gallery/' . $data->slug_url); ?>
    <div class="modal fade" tabindex="-1" role="dialog" id="tambah-data">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Foto Gallery Tour & Travel (<?php echo $data->nama_tour_travel ?>)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <input type="text" name="id_tour_travel" value="<?php echo $data->id ?>">
                <input type="text" name="nama_tour_travel" value="<?php echo $data->nama_tour_travel ?>">
                <div class="modal-body">
