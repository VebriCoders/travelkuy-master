            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?php echo base_url() ?>assets/img/upload/user-photo/<?= $user_aktif['photo']; ?>" class="rounded-circle mr-1">
                            <div class="d-sm-none d-lg-inline-block">Hi, <?= $user_aktif['nama']; ?></div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?php echo base_url(); ?>setting" class="dropdown-item has-icon">
